...
import { AlertTriangle, AlertCircle, AlertOctagon, CheckCircle2, Loader2, ArrowRight } from "lucide-react";
...
export default function AuditResult() {
  ...
  useEffect(() => {
    if (url && !createAudit.data && !createAudit.isPending && !createAudit.isError) {
      createAudit.mutate({ data: { url } });
    }
  }, [url]);
    ...
    return (
      <div className="container mx-auto px-4 py-24 text-center max-w-2xl">
        ...
        <p className="text-muted-foreground mb-8">
          We couldn't complete the automated scan for {url}. The site might be blocking our scanner or unreachable.
        </p>
        <Button asChild>

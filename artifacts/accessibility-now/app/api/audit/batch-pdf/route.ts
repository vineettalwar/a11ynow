  ...
  try {
    ...
    return new Response(new Uint8Array(pdfBuffer), {
      ...
      headers: {
        ...
        "Content-Disposition": `attachment; filename="accessibility-batch-report-${ordered.length}pages.pdf"`,
    ...
    return jsonErr(500, "pdf_failed", "Could not generate the batch PDF report.");
  }
}
